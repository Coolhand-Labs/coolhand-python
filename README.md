...
Monitor and log LLM API calls from OpenAI, Anthropic, Google Gemini, GitHub Copilot, Vertex AI, OpenRouter, OpenCode, Cloudflare AI Gateway, and more — including pydantic-ai and Dramatiq — to the Coolhand analytics platform.
