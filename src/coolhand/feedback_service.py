...
from .client import _validate_base_url
...
class FeedbackService:
    ...
    def __init__(self, config: Config | None = None, **kwargs):
        ...
        Args:
            ...
            **kwargs: Override config values (api_key, base_url, silent).
        """
        self.config: Config = {
        ...
        raw_base_url = self.config.get("base_url") or BASE_URL
        self._base_url = _validate_base_url(raw_base_url)
    ...
    def create_feedback(self, feedback: FeedbackData) -> FeedbackResponse | None:
        ...
        try:
            request = Request(
                url=f"{self._base_url}{FEEDBACK_ENDPOINT}",
    ...
    def _log_feedback_info(self, feedback: FeedbackData) -> None:
        ...
        self._log(f"Sending to: {self._base_url}{FEEDBACK_ENDPOINT}")
