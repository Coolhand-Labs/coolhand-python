...
Only the latest published version of `coolhand` on PyPI is supported with security fixes.
...
- [GitHub Security Advisories](https://github.com/Coolhand-Labs/coolhand-python/security/advisories/new)
